...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tag_name', models.CharField(choices=[('MOTION', '동작'), ('LOOKS', '형태'), ('SOUND', '소리'), ('EVENTS', '이벤트'), ('CONTROL', '제어'), ('SENSING', '감지'), ('OPERATORS', '연산'), ('VARIABLES', '변수'), ('MY', '내 블록'), ('ETC', '기타')], max_length=20, verbose_name='태그')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
