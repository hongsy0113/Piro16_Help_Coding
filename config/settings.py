...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '52.78.64.48','help-coding.com', 'www.help-coding.com']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'DB',
        'USER':'admin',
        'PASSWORD':get_secret("DB_PASSWORD"), # rds password
        'HOST':get_secret("DB_HOST"), # rds host
        'PORT':'3306',
        'OPTIONS': {
