...
urlpatterns = [
    ...
    path('<int:pk>/group_join_accept/', view=views.group_join_accept, name='group_join_accept'),
    path('<int:pk>/group_join_reject/', view=views.group_join_reject, name='group_join_reject'),
