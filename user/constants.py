...
# 업적 체계
REWARD_TYPE = (('total_like', '총 좋아요 수'), ('post_like', '게시글 좋아요 수'), ('comment_like', '댓글 좋아요 수'),
        ('total_post', '총 질문 수'), ('total_answer', '총 답변 수'), ('total_comment', '총 댓글 수'),
        ('total_group_joined', '총 가입한 그룹 수'), ('total_group_made', '총 개설한 그룹 수'))